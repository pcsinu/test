<?php
 if ( ! defined('BASEPATH')) exit('No direct script access allowed'); 
		...
		class CI_Resize_image
		{
			...
			public function resizeImage($fileName, $newWidth, $newHeight, $option, $path = NULL)
			{
				...
				if($path <> "")
					$this->saveImage($path, $imageQuality="100", $imageResized);
			...
			public function saveImage($savePath, $imageQuality="100", $image)
			{
				// *** Get extension
